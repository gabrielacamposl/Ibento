...
const verificar = () => {
    const [user, setUser] = useState({
        pictures: ["/jinG.jpeg","/jinG3.jpeg","/jinG1.jpeg"],
        ine:["/IneFront.jpeg",],
    });
    ...
    return (
        <div className="flex justify-center items-center min-h-screen custom-class" style={{ backgroundColor: '#f0f0f0' }}>
                            ...
                            <div className="grid grid-cols-3 mt-5">
                                {Array.from({ length: 6 }).map((_, index) => (
                                    <div key={index} className="relative">
                                        <div className="relative w-35 h-45 sm:w-35 sm:h-45 md:w-35 md:h-45 m-2 border-dashed divBorder flex items-center justify-center mt-6">
                                            {user.pictures[index] ? (
                                                <img
