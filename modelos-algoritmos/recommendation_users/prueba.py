...
def recomendacion_de_usuarios(preferencias_usuario, preferencias_candidato):
    ...
    for respuesta_usuario in preferencias_usuario:
        for respuesta_candidato in preferencias_candidato:
            ...
            if respuesta_usuario['pregunta'] == respuesta_candidato['pregunta']:
                usuario1[respuesta_usuario['pregunta']] = respuesta_usuario['respuesta']
                usuario2[respuesta_candidato['pregunta']] = respuesta_candidato['respuesta']
                lista_preguntas.append(respuesta_usuario['pregunta'])
                break
